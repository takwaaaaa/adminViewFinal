<header
    class="sticky top-0 flex w-full bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 z-99999 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-700 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 lg:py-4">

            <!-- Desktop Sidebar Toggle (xl+) -->
            <button
                class="hidden xl:flex items-center justify-center w-10 h-10 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700 rounded-lg lg:h-11 lg:w-11 hover:bg-gray-100 dark:hover:bg-gray-800"
            ...
            <!-- Mobile Menu Toggle -->
            <button
                class="flex xl:hidden items-center justify-center w-10 h-10 text-gray-500 dark:text-gray-400 rounded-lg lg:h-11 lg:w-11 hover:bg-gray-100 dark:hover:bg-gray-800"
                :class="{ 'bg-gray-100 dark:bg-gray-800': $store.sidebar.isMobileOpen }"
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden block" src="/images/logo/logo.svg" alt="Logo" />
                ...
                <form>
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Search or type command..."
                            class="dark:bg-gray-800 dark:text-white dark:border-gray-700 dark:placeholder:text-gray-500 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 xl:w-[430px]" />
                        <button class="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:text-gray-400">
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <button
                    ...
                    <svg x-show="$store.theme.theme === 'dark'" class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</header><?php /**PATH C:\laragon\www\AdminView\resources\views/layouts/app-header.blade.php ENDPATH**/ ?>