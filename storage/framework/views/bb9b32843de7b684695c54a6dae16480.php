                ...
                <li @click="handleItemClick()">
                    ...
                    >
                        <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                            ...
                            <span
                                class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white <?php echo e($notification['status'] === 'online' ? 'bg-success-500' : 'bg-error-500'); ?>"
                            ></span>
                        </span>
...
<?php /**PATH C:\laragon\www\AdminView\resources\views/components/header/notification-dropdown.blade.php ENDPATH**/ ?>