...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 mb-6">
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if($isSuperAdmin || $user->hasPermissionTo('consult_user_list')): ?>
            <a href="<?php echo e(route('users.index')); ?>" class="text-xs text-brand-500 hover:text-brand-600 font-medium">View all →</a>
            <?php endif; ?>
        </div>
        <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($totalUsers); ?></p>
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
        ...
        <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($activeUsers); ?></p>
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
        ...
        <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($inactiveUsers); ?></p>
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if($isSuperAdmin || $user->hasPermissionTo('consult_roles_list')): ?>
            <a href="<?php echo e(route('roles.index')); ?>" class="text-xs text-brand-500 hover:text-brand-600 font-medium">Manage →</a>
            <?php endif; ?>
        </div>
        <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($totalRoles); ?></p>
...
<div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
    ...
    <div class="xl:col-span-2 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
            ...
            <?php if($isSuperAdmin || $user->hasPermissionTo('create_user')): ?>
        ...
        <div class="flex flex-col items-center justify-center py-12 text-center">
            ...
            <?php if($isSuperAdmin || $user->hasPermissionTo('create_user')): ?>
            <a href="<?php echo e(route('users.create')); ?>" class="mt-3 text-xs text-brand-500 hover:underline font-medium">Add your first user</a>
            <?php endif; ?>
        </div>
        <?php else: ?>
        <div class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <div class="flex items-center gap-4 px-6 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                <div class="h-9 w-9 shrink-0 overflow-hidden rounded-full border border-gray-200 dark:border-gray-600">
                    <img src="<?php echo e($u->avatar_url); ?>" alt="<?php echo e($u->name); ?>" class="h-full w-full object-cover" />
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-800 dark:text-white truncate"><?php echo e($u->name); ?></p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($u->email); ?></p>
                </div>
        ...
        <div class="px-6 py-3 border-t border-gray-100 dark:border-gray-700">
            <a href="<?php echo e(route('users.index')); ?>" class="text-xs text-brand-500 hover:text-brand-600 font-medium">View all users →</a>
        </div>
        <?php endif; ?>
        <?php endif; ?>
    </div>
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
            ...
            <div class="flex flex-col gap-2">
                ...
                <?php if($isSuperAdmin || $user->hasPermissionTo('create_role')): ?>
                ...
                <?php if($isSuperAdmin || $user->hasPermissionTo('consult_logs')): ?>
                ...
                <?php if(!$isSuperAdmin && !$user->hasAnyPermission(['create_user','create_role','consult_logs'])): ?>
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 flex-1">
            ...
            <?php $roles = \Spatie\Permission\Models\Role::where('name', '!=', 'superadmin')->withCount('users')->get(); ?>
            ...
            <div class="flex items-center justify-between py-2.5 border-b border-gray-100 dark:border-gray-700 last:border-0">
                <span class="text-sm text-gray-700 dark:text-gray-300 capitalize"><?php echo e($role->name); ?></span>
