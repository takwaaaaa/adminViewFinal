            ...
            <tbody>
                <?php $__currentLoopData = $productsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t border-gray-100">
                        ...
                        <td class="py-3 whitespace-nowrap">
                            <p class="text-gray-500 text-theme-sm"><?php echo e($product['category']); ?></p>
                        </td>
                        <td class="py-3 whitespace-nowrap">
                            <p class="text-gray-500 text-theme-sm"><?php echo e($product['price']); ?></p>
                        </td>
                        <td class="py-3 whitespace-nowrap">
...
</div><?php /**PATH C:\laragon\www\AdminView\resources\views/components/ecommerce/recent-orders.blade.php ENDPATH**/ ?>